...
public class CompletableFutureTest01 {
    public static void main(String[] args) {
        ...
        //getPricesAsyncFuture(storeService);
        getPricesAsyncCompletableFuture(storeService);
    }
    ...
    private static void getPricesAsyncFuture(StoreService storeService) {
        long start = System.currentTimeMillis();
    ...
    private static void getPricesAsyncCompletableFuture(StoreService storeService) {
        long start = System.currentTimeMillis();
